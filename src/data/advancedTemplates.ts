...
// ── Time Series Analysis & Forecasting Template ─────────────────

export const timeSeriesTemplate: DashboardTemplate = {
  id: 'time-series-forecasting',
  name: 'Time Series & Forecasting',
  description: 'Monthly trend analysis with anomaly detection, linear regression forecasting, and seasonal patterns',
  category: 'Analytics',
  icon: 'TrendingUp',
  color: 'hsl(200, 85%, 50%)',
  sampleColumns: [
  ...
  widgets: [
    // KPIs
    { type: 'kpi', config: { id: '', type: 'kpi', title: 'Total Revenue', datasetId: '', valueField: 'revenue', aggregation: 'sum', prefix: '$', suffix: '', width: 1, height: 1, position: { x: 0, y: 0 } }, gridPosition: { x: 0, y: 0, w: 1, h: 1 } },
    { type: 'kpi', config: { id: '', type: 'kpi', title: 'Total Orders', datasetId: '', valueField: 'orders', aggregation: 'sum', prefix: '', suffix: '', width: 1, height: 1, position: { x: 1, y: 0 } }, gridPosition: { x: 1, y: 0, w: 1, h: 1 } },
    { type: 'kpi', config: { id: '', type: 'kpi', title: 'Avg Order Value', datasetId: '', valueField: 'avg_order_value', aggregation: 'avg', prefix: '$', suffix: '', width: 1, height: 1, position: { x: 2, y: 0 } }, gridPosition: { x: 2, y: 0, w: 1, h: 1 } },
    { type: 'gauge', config: { id: '', type: 'gauge', title: 'Churn Rate', datasetId: '', valueField: 'churn_rate', width: 1, height: 1, position: { x: 3, y: 0 } }, gridPosition: { x: 3, y: 0, w: 1, h: 1 } },
    // Line chart — Revenue trend (main time series)
    { type: 'line', config: { id: '', type: 'line', title: 'Revenue Trend (Monthly)', datasetId: '', xAxis: 'month', yAxis: 'revenue', width: 2, height: 2, position: { x: 0, y: 1 } }, gridPosition: { x: 0, y: 1, w: 2, h: 2 } },
    // Area chart — Orders over time
    { type: 'area', config: { id: '', type: 'area', title: 'Orders Over Time', datasetId: '', xAxis: 'month', yAxis: 'orders', width: 2, height: 2, position: { x: 2, y: 1 } }, gridPosition: { x: 2, y: 1, w: 2, h: 2 } },
    // Bar chart — Customer growth
    { type: 'bar', config: { id: '', type: 'bar', title: 'Customer Growth', datasetId: '', xAxis: 'month', yAxis: 'customers', width: 2, height: 2, position: { x: 0, y: 3 } }, gridPosition: { x: 0, y: 3, w: 2, h: 2 } },
    // Combo — Revenue vs Orders
    { type: 'combo', config: { id: '', type: 'combo', title: 'Revenue vs Orders', datasetId: '', xAxis: 'month', yAxis: 'revenue', labelField: 'month', valueField: 'orders', width: 2, height: 2, position: { x: 2, y: 3 } }, gridPosition: { x: 2, y: 3, w: 2, h: 2 } },
    // Sparklines for quick trends
    { type: 'sparkline', config: { id: '', type: 'sparkline', title: 'Revenue Sparkline', datasetId: '', valueField: 'revenue', width: 1, height: 1, position: { x: 0, y: 5 } }, gridPosition: { x: 0, y: 5, w: 1, h: 1 } },
    { type: 'sparkline', config: { id: '', type: 'sparkline', title: 'Churn Sparkline', datasetId: '', valueField: 'churn_rate', width: 1, height: 1, position: { x: 1, y: 5 } }, gridPosition: { x: 1, y: 5, w: 1, h: 1 } },
    // Scatter — correlation
    { type: 'scatter', config: { id: '', type: 'scatter', title: 'Orders vs Revenue', datasetId: '', xAxis: 'orders', yAxis: 'revenue', width: 2, height: 2, position: { x: 2, y: 5 } }, gridPosition: { x: 2, y: 5, w: 2, h: 2 } },
    // Waterfall — Month-over-month revenue change
    { type: 'waterfall', config: { id: '', type: 'waterfall', title: 'Revenue Changes', datasetId: '', labelField: 'month', valueField: 'revenue', width: 2, height: 2, position: { x: 0, y: 6 } }, gridPosition: { x: 0, y: 6, w: 2, h: 2 } },
    // Radar — multi-metric snapshot
    { type: 'radar', config: { id: '', type: 'radar', title: 'Metric Radar', datasetId: '', labelField: 'month', valueField: 'customers', width: 2, height: 2, position: { x: 2, y: 6 } }, gridPosition: { x: 2, y: 6, w: 2, h: 2 } },
    // Data Table
    { type: 'table', config: { id: '', type: 'table', title: 'Time Series Data', datasetId: '', width: 4, height: 2, position: { x: 0, y: 8 } }, gridPosition: { x: 0, y: 8, w: 4, h: 2 } },
  ],
};
