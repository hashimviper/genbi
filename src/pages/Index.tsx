...
export default function Index() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="border-b border-border/50 bg-background/80 backdrop-blur-lg px-6 py-4 fixed top-0 left-0 right-0 z-50">
        ...
        <div className="mx-auto flex max-w-6xl flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg overflow-hidden">
              <VisoryBILogo size={36} />
            </div>
            <span className="font-bold text-foreground">VisoryBI</span>
          </div>
